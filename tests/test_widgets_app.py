...
class TTApp(App):
    ...
    def __init__(self, app_name: str = "TT-App Example", app_version: str = "1.0.0", key_bindings: TextualKeyBindings = []) -> None:
    ...
    def on_mount(self) -> None:
        ...
        tt_dt.dt.add_rows([[f"{n}", f"Status {n}", f"This is description {n}", datetime.now().strftime("%b %d %Y %I:%M:%S %p")] for n in range(42)])
