...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Enable waiting for ethernet training post reset when using UMD.",
    )
...
def main():
    ...
    if args.reset is not None:
        ...
        if reset_input.type == ResetType.ALL:
            ...
            pci_board_reset(reset_indices, reinit=not(args.no_reinit), print_status=is_tty, use_umd=not args.use_luwen, wait_for_eth=args.enable_eth_wait)
