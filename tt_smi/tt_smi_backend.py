...
def pci_board_reset(list_of_boards: List[int], reinit: bool = False, print_status: bool = True):
    ...
    if is_galaxy:
        # TODO: it would be clearer to print this only in case of running into this scenario on Galaxy
        # figure out where the failure point is with insufficient CPLD version
        # or how to read version
        print(
